...
- `dev-practices.md` — configurable process decisions: test-writing timing, whether automated
  tests gate `Confirmed`, local verification requirements, whether the two-reviewer gate (project
  + framework) runs before every push — fill in before starting real work
